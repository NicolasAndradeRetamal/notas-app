    ...
    <div className="space-y-6 md:space-y-8">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="space-y-1">
          <h1 className="text-ink text-2xl font-bold tracking-tight md:text-3xl">Papelera</h1>
          <p className="text-meta text-ink-subtle">
            {pluralize(result.total, 'nota eliminada', 'notas eliminadas')} · se conservan hasta que
            las elimines definitivamente
          </p>
        </div>
      ...
      {result.items.length === 0 ? (
        <EmptyState
          ...
          description="Las notas que elimines aparecerán aquí hasta que las elimines definitivamente."
        />
      ) : (
